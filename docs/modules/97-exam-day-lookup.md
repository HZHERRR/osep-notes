...
| 入口 | 场景 | 模块文档 |
|---|---|---|
| Word 文档投递（后台用户打开） | 1, 2, 3, 4, 5, 17 | [`docs/01-word-vba-office.md`](/modules/01-word-vba-office) |
| 邮件链接 / HTA | 6, 7, 8 | [`docs/02-hta.md`](/modules/02-hta) |
| 邮件附件（JScript/脚本） | 9, 10, 17 | [`docs/03-jscript-dotnettojscript.md`](/modules/03-jscript-dotnettojscript) |
| ZIP 附件（宿主 + DLL） | 11, 12 | [`docs/04-dll-sideloading.md`](/modules/04-dll-sideloading) |
| 日历邀请（ICS） | 13 | [`docs/16-ics-calendar.md`](/modules/16-ics-calendar) |
| Web 上传 ASPX（IIS） | 14 | [`docs/10-web-entry-webshell.md`](/modules/10-web-entry-webshell) |
| Web SQL 注入 | 15, 44 | [`docs/10-web-entry-webshell.md`](/modules/10-web-entry-webshell)、[`docs/11-mssql.md`](/modules/11-mssql) |
| Web 命令注入 | 16 | [`docs/10-web-entry-webshell.md`](/modules/10-web-entry-webshell) |
| 自定义 EXE 投递 | 18, 19, 20 | [`docs/05-applocker-clm-amsi.md`](/modules/05-applocker-clm-amsi) |
| AppLocker 允许目录 | 21, 22 | [`docs/05-applocker-clm-amsi.md`](/modules/05-applocker-clm-amsi) |
| 受信任宿主（InstallUtil/Workflow/XSL） | 23, 24 | [`docs/05-applocker-clm-amsi.md`](/modules/05-applocker-clm-amsi) |
| 本地管理员普通令牌 | 25 | [`docs/06-uac-windows-privesc.md`](/modules/06-uac-windows-privesc) |
| 服务账户 + SeImpersonate | 26 | [`docs/06-uac-windows-privesc.md`](/modules/06-uac-windows-privesc) |
| 服务配置/路径可写 | 27 | [`docs/06-uac-windows-privesc.md`](/modules/06-uac-windows-privesc) |
| 企业代理出网 | 28, 29 | [`docs/09-c2-egress-channels.md`](/modules/09-c2-egress-channels) |
| 分阶段通信 | 30, 31 | [`docs/09-c2-egress-channels.md`](/modules/09-c2-egress-channels) |
| DNS 通道 / 域前置 | 32, 33 | [`docs/09-c2-egress-channels.md`](/modules/09-c2-egress-channels) |
| 内网跳板 | 34, 35 | [`docs/08-pivoting-tunneling.md`](/modules/08-pivoting-tunneling) |
| Linux 上传站（执行 ELF） | 36, 37 | [`docs/13-linux.md`](/modules/13-linux) |
| Linux 共享库加载 | 38 | [`docs/13-linux.md`](/modules/13-linux) |
| sudo 单程序 | 39 | [`docs/13-linux.md`](/modules/13-linux) |
| 制品库（Artifactory） | 40 | [`docs/13-linux.md`](/modules/13-linux) |
| Kiosk 受限桌面 | 41 | [`docs/14-kiosk-jea-jit.md`](/modules/14-kiosk-jea-jit) |
| JEA 端点 | 42 | [`docs/14-kiosk-jea-jit.md`](/modules/14-kiosk-jea-jit) |
| JIT 临时权限 | 43 | [`docs/14-kiosk-jea-jit.md`](/modules/14-kiosk-jea-jit) |
| SQL 低权限登录 | 44 | [`docs/11-mssql.md`](/modules/11-mssql) |
| Linked Server | 45 | [`docs/11-mssql.md`](/modules/11-mssql) |
| 本地高权限 + LSASS 保护 | 46 | [`docs/07-credentials-lsass.md`](/modules/07-credentials-lsass) |
| 加域 Linux 票据 | 47 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| SSH 复用连接 | 48 | [`docs/13-linux.md`](/modules/13-linux) |
| 域用户可读 LAPS | 49 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| 非约束委派主机 | 50 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| 计算机对象写权限 | 51 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| 约束委派服务账户 | 52 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| 子域 → 林根 | 53 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| ADCS ESC1 | 54 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| ADCS ESC8 | 55 | [`docs/12-ad-attacks.md`](/modules/12-ad-attacks) |
| 仅 WinRM 可达 | 56 | [`docs/15-winrm-lateral.md`](/modules/15-winrm-lateral) |
